...
public:
	...
	/**  */
	void		setPoint2D( const float2&  );
	
	/**  */
	void		setCircle2D( const float2&, float, float  );
	
	/**  */
	void		setLine2D( const float2&, const float2& );
	
	/**  */
	void		setBox2D( const float2&, const float2& );
	
	/**  */
	void		setRectangle2D( const float2&, const float2&, const float2& );
	
	/**  */
	void		setTriangle2D( const float2&, const float2&, const float2& );
	 ...
	 * 
	 */
	void		getRandom( float2* v ) const			{*v=getRandomFloat2();}
