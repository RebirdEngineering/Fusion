...
#include <list>
#include <memory>
#include <cstdlib> //We have to do this since WEBP depends on the original names, they probably ditched the manual typedefs for STD
#include <cassert>
#include <assert.h>
//end
...
#ifdef PLATFORM_SUPPORTS_NAMESPACES //Likely ditched
