...
public:
	...
	enum LockType
	{
		...
		LOCK_READWRITE	= 3,
        /**  */
        LOCK_READ_VERTEXONLY		= 5,
		/**  */
		LOCK_WRITE_VERTEXONLY		= 6,
		/**  */
		LOCK_READWRITE_VERTEXONLY	= 7,
		/**  */
		LOCK_VERTEXONLY_FLAG = 4 //Why the confusing order
	};
	 ...
	 * 
	 */
	virtual bool		isVertexOnlyLock( LockType lock );
